...
use crate::{
    ...
    ViewMarker, ViewSequence, HTML_NS, MATHML_NS, SVG_NS,
};
...
macro_rules! define_element {
    (($ns:expr, $ty_name:ident, $name:ident, $dom_interface:ident)) => {
        define_element!(($ns, $ty_name, $name, $dom_interface, stringify!($name), T, A, VS));
    };
...
define_elements!(
    ...
    (MATHML_NS, AnnotationXml, annotation_xml, Element, "annotation-xml", T, A, VS),
