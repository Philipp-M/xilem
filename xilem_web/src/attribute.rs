...
use crate::{
    ...
    vecmap::VecMap,
    AttributeValue, DomNode, DomView, DynMessage, ElementProps, IntoAttributeValue, PodMut,
    ViewCtx,
};
...
impl AsMut<Attributes> for ElementProps {
...
where
    State: 'static,
    Action: 'static,
    V: DomView<State, Action, DomNode: DomNode<Props: AsMut<Attributes>>>,
{
    ...
    fn build(&self, ctx: &mut ViewCtx) -> (Self::Element, Self::ViewState) {
        ...
        element.props.as_mut().push(self.modifier.clone());
        (element, state)
    }
    ...
    fn rebuild(
        ...
        Attributes::rebuild(element, 1, |mut element| {
            ...
            let attrs = element.props.as_mut();
