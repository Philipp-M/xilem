...
impl AsMut<Classes> for ElementProps {
...
where
    ...
    A: 'static,
    C: ClassIter,
    E: DomView<T, A, DomNode: DomNode<Props: AsMut<Classes>>>,
{
    ...
    fn build(&self, ctx: &mut ViewCtx) -> (Self::Element, Self::ViewState) {
        ...
        let len = e.props.as_mut().extend(add_class_iter);
        (e, (len, s))
    }
