...
use crate::{
    ...
    vecmap::VecMap,
    DomNode, DomView, DynMessage, ElementProps, PodMut, ViewCtx,
};
...
impl AsMut<Styles> for ElementProps {
...
impl Styles {
    ...
    pub fn rebuild<'a, N>(this: PodMut<'a, N>, prev_len: usize, f: impl FnOnce(PodMut<'a, N>))
    where
        N: DomNode<Props: AsMut<Self>>,
    {
        this.props.as_mut().idx -= prev_len as u16;
        f(this);
    }
...
impl<E, C, T, A> ViewMarker for Style<E, C, T, A> {}
impl<E, C, T, A> View<T, A, ViewCtx, DynMessage> for Style<E, C, T, A>
where
    T: 'static,
    A: 'static,
    C: StyleIter,
    E: DomView<T, A, DomNode: DomNode<Props: AsMut<Styles>>>,
{
    type Element = E::Element;

    type ViewState = (usize, E::ViewState);
    ...
    fn build(&self, ctx: &mut ViewCtx) -> (Self::Element, Self::ViewState) {
        ...
        let len = e.props.as_mut().extend(style_iter);
        (e, (len, s))
    }
    ...
    E: DomView<T, A, DomNode: DomNode<Props: AsMut<Styles>>>,
{
    ...
    fn build(&self, ctx: &mut ViewCtx) -> (Self::Element, Self::ViewState) {
        ...
        let styles = element.props.as_mut();
    ...
    fn rebuild(
        ...
        Styles::rebuild(element, 1, |mut element| {
            ...
            element.props.as_mut().update_mutator(
                "transform",
                &prev.radians,
                &self.radians,
